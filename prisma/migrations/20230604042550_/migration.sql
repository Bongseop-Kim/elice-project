...
-- AddForeignKey
ALTER TABLE `Reservation` ADD CONSTRAINT `Reservation_isUsersKidId_fkey` FOREIGN KEY (`isUsersKidId`) REFERENCES `Kid`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Image` ADD CONSTRAINT `Image_kidId_fkey` FOREIGN KEY (`kidId`) REFERENCES `Kid`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
